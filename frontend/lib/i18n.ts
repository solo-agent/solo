...
const en = {
  ...
  taskDependenciesTitle: 'Dependencies',
  taskBlockedByLabel: 'Blocked by',
  taskBlockingLabel: 'Blocks',
  taskNoDependencies: 'No dependencies. Add one to link tasks.',
  taskAddDependency: 'Add',
  taskAddDependencyTitle: 'Add dependency for #{n}',
  taskRemoveDependency: 'Remove #{n}',
  taskSearchDependencyPlaceholder: 'Search by #number or title...',
  taskNoMatchingTasks: 'No matching tasks found.',
  taskAllTasksLinked: 'All other tasks are already linked.',
  taskDependencyBlocksThis: 'Blocks this',
  taskDependencyBlockedByThis: 'Blocked by this',
