...
const en = {
  ...
  themeBlueprint: 'Blueprint Soda',
  themeUltraviolet: 'Ultraviolet Studio',
  themeSeasalt: 'Sea Salt Orange',
  themeTomato: 'Tomato Radio',
  themeMatcha: 'Matcha Blue',
  themeBubblegum: 'Bubblegum',
  themeLavender: 'Lavender Lemon',
  themeSky: 'Clear Sky Orange',
  settingsSave: 'Save',
