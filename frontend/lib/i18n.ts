...
const en = {
  ...
  themeClassic: 'Classic Sunlight',
  themeBlueprint: 'Light Modern',
  themeUltraviolet: 'GitHub Light',
  themeSeasalt: 'Quiet Light',
  themeTomato: 'Solarized Light',
  themeMatcha: 'Ayu Light',
  themeBubblegum: 'Catppuccin Latte',
  themeLavender: 'Rosé Pine Dawn',
  themeSky: 'Gruvbox Light',
  settingsSave: 'Save',
...
const zhCN = {
  ...
  themeClassic: '经典日光',
  themeBlueprint: '明亮现代',
  themeUltraviolet: 'GitHub 浅色',
  themeSeasalt: '静谧浅色',
  themeTomato: 'Solarized 浅色',
  themeMatcha: 'Ayu 浅色',
  themeBubblegum: 'Catppuccin 拿铁',
  themeLavender: 'Rosé Pine 黎明',
  themeSky: 'Gruvbox 浅色',
  settingsSave: '保存',
  settingsSaving: '保存中...',
