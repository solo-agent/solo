...
const en = {
  ...
  agentRuntimeAutoJoin: 'Auto-join Channels',
  agentRuntimeAutoJoinEnabled: 'Agent automatically joins all channels on creation',
  agentRuntimeAutoJoinDisabled: 'Agent must be manually added to channels',
  agentRuntimeMaxTokens: 'Maximum number of tokens per response.',
  agentRuntimeTemperature: 'Controls output randomness. Lower values are more deterministic, higher values more varied.',
