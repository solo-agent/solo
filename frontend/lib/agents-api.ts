...
//
// Right now this only exposes mention-candidates (T1.4.1 backend). The
// generic CRUD for /api/v1/agents lives in apiClient calls scattered
// through hooks; we only centralize endpoints that don't have a dedicated
// hook.
// ============================================================================
