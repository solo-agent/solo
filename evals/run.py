...
def main():
    ...
    dataset=ROOT/'evals/datasets'/('solo-skills-v3.json' if args.dataset=='native' else 'humaneval-smoke.json')
    ...
    if args.generate_from:
        ...
        dataset.write_text(json.dumps(learning_case(args.generate_from.resolve(),ROOT/'evals/datasets/solo-skills-v3.json'),ensure_ascii=False,indent=2))
