...
| `tomato` | Solarized Light | `#FDF6E3` | `#E8AA63` | `#75C1BC` | `#A9B858` | `#E27D61` |
| `matcha` | Ayu Light | `#FAFAFA` | `#F5AD66` | `#C6A1E4` | `#B0CD61` | `#F39A9A` |
| `bubblegum` | Catppuccin Latte | `#EFF1F5` | `#CBA6F7` | `#89B4FA` | `#A6E3A1` | `#F38BA8` |
| `lavender` | Rosé Pine Dawn | `#FAF4ED` | `#EBBCBA` | `#C4A7E7` | `#A3BEA3` | `#D99AAA` |
| `sky` | Gruvbox Light | `#FBF1C7` | `#B8BB26` | `#D3869B` | `#8EC07C` | `#FB4934` |
